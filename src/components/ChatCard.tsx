...
import MoreHorizontal from "../../public/assets/svg/moreHorizontal"
import Heart from "../../public/assets/svg/heart"
import Share from "../../public/assets/svg/share"
import Image from "next/image"
import { chatCardInterface } from "@/moduleInterface/module"
...
export default function ChatCard({ content = '', timestamp, sender, bullish, senderAvatar, likes, comments }:chatCardInterface) {
    return (
